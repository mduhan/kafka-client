...
/**
 * Helper class for {@link ListenableFuture} implementations that maintains a of success and failure callbacks
 * and helps to notify them.
 *
 * <p>
 * Inspired by {@code com.google.common.util.concurrent.ExecutionList}. Included to make it compatible with
 * lower versiond
 *
 * mduhan
 * 
...
public class ListenableFutureCallbackRegistry<T> {
  ...
  /**
   * Trigger a {@link ListenableFutureCallback#onSuccess(Object)} call on all added callbacks with the given
   * result.
   * 
   * @param result
  ...
  /**
   * Trigger a {@link ListenableFutureCallback#onFailure(Throwable)} call on all added callbacks with the
