...
/**
 * Extension of {@link FutureTask} that implements . Included to make it compatible with lower versiond
 *
 *
 * @author mduhan
 */
public class ListenableFutureTask<T> extends FutureTask<T> implements ListenableFuture<T> {
  ...
  /**
   * Create a {@code ListenableFutureTask} that will, upon running, execute the given {@link Runnable}, and
   * arrange that {@link #get()} will return the given result on successful completion.
   * 
   * @param runnable
   *          the runnable task
   * @param result
