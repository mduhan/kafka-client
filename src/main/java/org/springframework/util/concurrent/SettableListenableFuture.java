...
public class SettableListenableFuture<T> implements ListenableFuture<T> {
   ...
   * {@link #setException(Throwable)}, or throws a {@link java.util.concurrent.CancellationException} if the
  ...
  /**
   * Subclasses can override this method to implement interruption of the future's computation. The method is
   * invoked automatically by a successful call to {@link #cancel(boolean) cancel(true)}.
   * <p>
